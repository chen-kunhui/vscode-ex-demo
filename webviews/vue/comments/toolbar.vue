...
<template>
  <div class="nx-comment-toolbar">
    <div class="left-tools" v-show="false">
      <span title="添加标题" @click="addH3">
	...
	<div class="left-tools" v-show="true">
	</div>
    <div>
